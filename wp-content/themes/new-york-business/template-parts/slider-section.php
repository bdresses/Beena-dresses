...
<div id="main_Carousel" class="carousel slide <?php if( $new_york_business_option['slider_animation_type']=='fade' ){ echo 'carousel-' . 'fade'; } ?>" data-ride="carousel"  data-interval="<?php echo absint( $new_york_business_option['slider_speed']); ?>">
